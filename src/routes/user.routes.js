...
router.route("/avatar").patch(veriyJWT, upload.single("avatar"), updateUserAvatar)// Hence here aswell updateUserAvatar can only be routed to the users who are verified(loggedin), thats why we used verifyJWT, also upload.single("avatar") is used to upload a single file with the name "avatar"
...
router.route("/histoy").get(verifyJWT, getWatchHistory) // Hence here aswell getWatchHistory can only be routed to the users who are verified(loggedin), thats why we used verifyJWT
